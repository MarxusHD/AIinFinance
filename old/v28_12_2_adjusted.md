...
```
    ...
    sp_debt_to_capital       0.238925
    evt_cfo_negative        -0.153062
    log_at                   0.149348
    sp_interest_coverage     0.117417
    log_mkvalt               0.094564
    sp_debt_to_ebitda        0.092599
    evt_cov_breach          -0.089719
    evt_ebitda_shock         0.059807
    evt_quick_squeeze        0.043940
    evt_div_initiate         0.043762
    sp_dcf_to_debt           0.040070
    evt_liquidity_squeeze    0.037140
    evt_div_cut              0.029295
    sp_ffo_to_debt           0.026566
    sp_focf_to_debt          0.026348
    evt_div_suspend          0.022109
    evt_cfo_collapse         0.021253
    evt_lev_spike           -0.010428
    evt_cov_collapse        -0.010312
    sp_cfo_to_debt          -0.002089
    Name: target_next_year_distress, dtype: float64
    
    === Multicollinearity Diagnostic (VIF) ===
                       feature        VIF
    3        z_sp_focf_to_debt  10.890813
    4         z_sp_dcf_to_debt   6.521193
    16       evt_quick_squeeze   3.831942
    15   evt_liquidity_squeeze   3.786172
    12          evt_cov_breach   3.777438
    2         z_sp_cfo_to_debt   3.404249
    18        evt_cfo_negative   3.218981
    9              evt_div_cut   2.584489
    10         evt_div_suspend   2.541220
    6   z_sp_interest_coverage   2.144992
    1         z_sp_ffo_to_debt   2.069387
    7                 z_log_at   1.395043
    8             z_log_mkvalt   1.335057
    17        evt_ebitda_shock   1.169546
    5      z_sp_debt_to_ebitda   1.125191
    11        evt_div_initiate   1.103968
    0     z_sp_debt_to_capital   1.097094
    13        evt_cov_collapse   1.069383
    19        evt_cfo_collapse   1.066520
    14           evt_lev_spike   1.044739
    ...
    === TRAIN === rows=44,783 | firms=9,220 | years=7 | target_rate=0.1075
    ...
    Distribution summary (TRAIN | winsorized raw feats)
                               n      mean       std        min        p01  \
    evt_lev_spike          44783    0.0061    0.0777     0.0000     0.0000   
    evt_div_suspend        44783    0.0183    0.1339     0.0000     0.0000   
    sp_dcf_to_debt         44783  -26.1977  206.7528 -1724.5155 -1724.0928   
    sp_debt_to_ebitda      44783  109.9131  745.1325 -1253.8595 -1253.7697   
    ...
    sp_debt_to_capital     44783    0.3125    0.5945    -2.7862    -2.7828   
    ...
    evt_lev_spike           0.0000  0.0000   0.0000   0.0000   0.0000     0.0000   
    evt_div_suspend         0.0000  0.0000   0.0000   0.0000   0.0000     1.0000   
    sp_dcf_to_debt        -34.0200 -0.2690  -0.0162   0.0922   3.1968   357.6861   
    sp_debt_to_ebitda      -7.2928  0.0000   0.2768   3.5542  31.1958  5667.0715   
    ...
    sp_debt_to_capital     -0.0001  0.0002   0.2455   0.5571   1.0013     2.7859   
    ...
    evt_cov_breach          0.0000  0.0000   0.0000   1.0000   1.0000     1.0000   
                                 ...
                                 max     skew      kurt  
    evt_lev_spike             1.0000  12.7146  159.6675  
    evt_div_suspend           1.0000   7.1951   49.7712  
    sp_dcf_to_debt          357.7370  -6.8666   51.2077  
    sp_debt_to_ebitda      5667.1637   6.0019   38.8569  
    ...
    sp_debt_to_capital        2.7876  -0.6993   10.4693  
    ...
    evt_lev_spike           44783  0.0061  0.0777  0.0000  0.0000  0.0000  0.0000   
    ...
    z_sp_debt_to_ebitda     44783  0.0000  1.0000 -1.8302 -1.8301 -0.1573 -0.1475   
    ...
    z_sp_debt_to_capital    44783  0.0000  1.0000 -5.2123 -5.2065 -0.5258 -0.5253   
    ...
    evt_lev_spike           0.0000  0.0000  0.0000  0.0000  1.0000  12.7146   
    evt_div_suspend         0.0000  0.0000  0.0000  1.0000  1.0000   7.1951   
    z_sp_dcf_to_debt        0.1266  0.1272  0.1422  1.8567  1.8570  -6.8666   
    z_sp_debt_to_ebitda    -0.1471 -0.1427 -0.1056  7.4579  7.4581   6.0019   
    ...
    z_sp_debt_to_capital   -0.1126  0.4114  1.1586  4.1604  4.1632  -0.6993   
    ...
    evt_cov_breach          0.0000  1.0000  1.0000  1.0000  1.0000   0.0741   
                                ...
                                kurt  
    evt_lev_spike           159.6675  
    evt_div_suspend          49.7712  
    z_sp_dcf_to_debt         51.2077  
    z_sp_debt_to_ebitda      38.8569  
    evt_div_cut              28.1335  
    ...
    0      sp_debt_to_capital      0.3125     0.3575  0.0774   0.0774
    ...
    14          evt_lev_spike      0.0061     0.0068  0.0087   0.0087
    12         evt_cov_breach      0.4815     0.4854  0.0079   0.0079
    
    Mean difference (target=1 minus target=0) on TRAIN feats [top 15]:
    sp_debt_to_ebitda        222.7597
    sp_dcf_to_debt            26.7464
    sp_ffo_to_debt            19.8502
    sp_focf_to_debt           15.4714
    log_at                     1.7189
    log_mkvalt                 1.2231
    sp_interest_coverage       1.1395
    sp_cfo_to_debt            -1.0659
    sp_debt_to_capital         0.4586
    evt_cfo_negative          -0.2372
    evt_cov_breach            -0.1447
    evt_quick_squeeze          0.0646
    evt_liquidity_squeeze      0.0536
    evt_div_initiate           0.0391
    evt_ebitda_shock           0.0381
    dtype: float64
...
```
    ...
    dtype: float64
    size_decile
    (-0.001, 6.528]     0.028255
    (6.528, 8.356]      0.090424
    (8.356, 9.487]      0.093454
    (9.487, 10.488]     0.057600
    (10.488, 11.476]    0.050927
    (11.476, 12.507]    0.075600
    (12.507, 13.39]     0.098400
    (13.39, 14.213]     0.147580
    (14.213, 15.218]    0.185067
    (15.218, 21.886]    0.205573
...
```
    ...
    Modeling matrix shapes:
      X_train: (44783, 20) | y_train mean=0.1075
      X_val:   (6415, 20) | y_val mean=0.0929
      X_test:  (12404, 20) | y_test mean=0.1051
...
```
    ...
    Best LogisticRegression on VAL: C=10.0 | AUC=0.8130
...
```
    ...
    Date:                Sun, 28 Dec 2025   Pseudo R-squ.:                  0.1565
    Time:                        19:45:32   Log-Likelihood:                -12890.
    converged:                       True   LL-Null:                       -15282.
    Covariance Type:              cluster   LLR p-value:                     0.000
    ==========================================================================================
                                 coef    std err          z      P>|z|      [0.025      0.975]
    ------------------------------------------------------------------------------------------
    const                     -2.5232      0.062    -40.560      0.000      -2.645      -2.401
    z_sp_debt_to_capital       0.9483      0.030     31.668      0.000       0.890       1.007
    z_sp_ffo_to_debt           0.1314      0.049      2.697      0.007       0.036       0.227
    z_sp_cfo_to_debt          -0.2568      0.088     -2.918      0.004      -0.429      -0.084
    z_sp_focf_to_debt         -0.2044      0.215     -0.951      0.342      -0.626       0.217
    z_sp_dcf_to_debt           0.3851      0.182      2.116      0.034       0.028       0.742
    z_sp_debt_to_ebitda        0.1086      0.014      7.529      0.000       0.080       0.137
    z_sp_interest_coverage     0.2054      0.050      4.147      0.000       0.108       0.303
    z_log_at                   0.3808      0.032     11.780      0.000       0.317       0.444
    z_log_mkvalt               0.0157      0.026      0.594      0.553      -0.036       0.067
    evt_div_cut                0.0821      0.122      0.673      0.501      -0.157       0.321
    evt_div_suspend            0.2286      0.161      1.421      0.155      -0.087       0.544
    evt_div_initiate           0.2121      0.047      4.466      0.000       0.119       0.305
    evt_cov_breach             0.1013      0.093      1.088      0.277      -0.081       0.284
    evt_cov_collapse          -0.0704      0.100     -0.702      0.483      -0.267       0.126
    evt_lev_spike             -2.8351      0.303     -9.367      0.000      -3.428      -2.242
    evt_liquidity_squeeze      0.0508      0.076      0.665      0.506      -0.099       0.201
    evt_quick_squeeze          0.2154      0.076      2.828      0.005       0.066       0.365
    evt_ebitda_shock           0.0516      0.078      0.663      0.507      -0.101       0.204
    evt_cfo_negative          -0.8956      0.094     -9.570      0.000      -1.079      -0.712
    evt_cfo_collapse           0.4456      0.081      5.480      0.000       0.286       0.605
    ==========================================================================================
    ...
    ------------------------------------------------------------------------------
    x1             0.0562      0.002     28.073      0.000       0.052       0.060
    x2             0.0078      0.003      2.701      0.007       0.002       0.013
    x3            -0.0152      0.005     -2.919      0.004      -0.025      -0.005
    x4            -0.0121      0.013     -0.953      0.341      -0.037       0.013
    x5             0.0228      0.011      2.126      0.033       0.002       0.044
    x6             0.0064      0.001      7.449      0.000       0.005       0.008
    x7             0.0122      0.003      4.115      0.000       0.006       0.018
    x8             0.0226      0.002     12.033      0.000       0.019       0.026
    x9             0.0009      0.002      0.593      0.553      -0.002       0.004
    x10            0.0049      0.007      0.673      0.501      -0.009       0.019
    x11            0.0135      0.010      1.419      0.156      -0.005       0.032
    x12            0.0126      0.003      4.449      0.000       0.007       0.018
    x13            0.0060      0.006      1.087      0.277      -0.005       0.017
    x14           -0.0042      0.006     -0.702      0.483      -0.016       0.007
    x15           -0.1679      0.018     -9.408      0.000      -0.203      -0.133
    x16            0.0030      0.005      0.666      0.506      -0.006       0.012
    x17            0.0128      0.005      2.820      0.005       0.004       0.022
    x18            0.0031      0.005      0.663      0.507      -0.006       0.012
    x19           -0.0531      0.005     -9.719      0.000      -0.064      -0.042
    x20            0.0264      0.005      5.437      0.000       0.017       0.036
    ==============================================================================
    
    Model Fit:
      Pseudo R2 (McFadden): 0.1565
      AIC: 25822.39
      BIC: 26005.29
...
```
    ...
    0     1      2018       2017  0.8133  0.2806
    1     2      2019       2018  0.8105  0.3226
    2     3      2020       2019  0.8119  0.3170
    3     4      2021       2020  0.8074  0.2536
    
    Average AUC across folds: 0.8108
...
```
    ...
    AUC (ROC): 0.8130
    Average Precision (PR-AUC): 0.2607
    Brier score (calibration): 0.1871
    Threshold: 0.637
    ...
    Classification report:
               ...
               0     0.9509    0.8584    0.9023      5819
               1     0.2909    0.5671    0.3845       596
    
        accuracy                         0.8313      6415
       macro avg     0.6209    0.7128    0.6434      6415
    weighted avg     0.8896    0.8313    0.8542      6415
    
    Sensitivity (Recall of Distress): 0.5671
    Specificity (Recall of Non-Distress): 0.8584
    
    === TEST (same threshold) ===
    AUC (ROC): 0.8094
    Average Precision (PR-AUC): 0.2716
    Brier score (calibration): 0.1956
    Threshold: 0.637
    Confusion matrix [ [TN FP] [FN TP] ]:
    [[9413 1687]
     [ 568  736]]
    ...
    Classification report:
               ...
               0     0.9431    0.8480    0.8930     11100
               1     0.3038    0.5644    0.3950      1304
    
        accuracy                         0.8182     12404
       macro avg     0.6234    0.7062    0.6440     12404
    weighted avg     0.8759    0.8182    0.8407     12404
    
    Sensitivity (Recall of Distress): 0.5644
    Specificity (Recall of Non-Distress): 0.8480
...
```
    ...
    HistGradientBoosting (no heavy tuning):
      VAL  AUC=0.9014 | PR-AUC=0.5583
      TEST AUC=0.9125 | PR-AUC=0.6347
