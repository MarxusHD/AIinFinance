...
```
    ...
    /var/folders/p1/_cwwbdbj51q1lwpynfnzdxpm0000gn/T/ipykernel_7030/2286657439.py:434: FutureWarning: Downcasting object dtype arrays on .fillna, .ffill, .bfill is deprecated and will change in a future version. Call result.infer_objects(copy=False) instead. To opt-in to the future behavior, set `pd.set_option('future.no_silent_downcasting', True)`
      obs_lag = obs_now.groupby(df["firm_id"]).shift(1).fillna(False)
    /var/folders/p1/_cwwbdbj51q1lwpynfnzdxpm0000gn/T/ipykernel_7030/2286657439.py:434: FutureWarning: Downcasting object dtype arrays on .fillna, .ffill, .bfill is deprecated and will change in a future version. Call result.infer_objects(copy=False) instead. To opt-in to the future behavior, set `pd.set_option('future.no_silent_downcasting', True)`
      obs_lag = obs_now.groupby(df["firm_id"]).shift(1).fillna(False)
    /var/folders/p1/_cwwbdbj51q1lwpynfnzdxpm0000gn/T/ipykernel_7030/2286657439.py:434: FutureWarning: Downcasting object dtype arrays on .fillna, .ffill, .bfill is deprecated and will change in a future version. Call result.infer_objects(copy=False) instead. To opt-in to the future behavior, set `pd.set_option('future.no_silent_downcasting', True)`
...
```
    ...
    Coverage collapse threshold (ratio) used: -0.371
...
```
    ...
    sp_interest_coverage    0.006293
    sp_cfo_to_debt         -0.002089
    Name: target_next_year_distress, dtype: float64
    
    === Multicollinearity Diagnostic (VIF) ===
                      feature        VIF
    3       z_sp_focf_to_debt  10.882316
    4        z_sp_dcf_to_debt   6.504007
    2        z_sp_cfo_to_debt   3.365198
    1        z_sp_ffo_to_debt   2.013623
    7                z_log_at   1.252917
    8            z_log_mkvalt   1.210514
    0    z_sp_debt_to_capital   1.060711
    5     z_sp_debt_to_ebitda   1.015599
    6  z_sp_interest_coverage   1.005372
    ...
    Distribution summary (TRAIN | winsorized raw feats)
                              n          mean           std           min  \
    sp_dcf_to_debt        44783 -2.619770e+01  2.067528e+02 -1.724515e+03   
    sp_debt_to_ebitda     44783  1.099131e+02  7.451325e+02 -1.253860e+03   
    sp_ffo_to_debt        44783 -1.484170e+01  2.314420e+02 -1.852128e+03   
    sp_focf_to_debt       44783 -1.368230e+01  1.818769e+02 -1.436704e+03   
    sp_interest_coverage  44783 -6.636551e+07  6.449450e+09 -3.273444e+10   
    log_mkvalt            44783  7.052600e+00  4.006300e+00  4.260000e-01   
    sp_debt_to_capital    44783  3.125000e-01  5.945000e-01 -2.786200e+00   
    log_at                44783  1.107300e+01  3.565000e+00  6.931000e-01   
    sp_cfo_to_debt        44783  4.850300e+00  1.580296e+02 -9.545940e+02   
    
                                   p01           p05     p25      p50      p75  \
    sp_dcf_to_debt       -1.724093e+03 -3.402000e+01 -0.2690  -0.0162   0.0922   
    sp_debt_to_ebitda    -1.253770e+03 -7.292800e+00  0.0000   0.2768   3.5542   
    sp_ffo_to_debt       -1.850711e+03 -2.207810e+01 -0.1073   0.0984   0.2931   
    sp_focf_to_debt      -1.435762e+03 -2.075450e+01 -0.1556   0.0470   0.1927   
    sp_interest_coverage -3.272588e+10 -2.220500e+09 -7.8422   2.0243  11.4281   
    log_mkvalt            4.260000e-01  1.566700e+00  4.1728   6.3628   9.0370   
    sp_debt_to_capital   -2.782800e+00 -1.000000e-04  0.0002   0.2455   0.5571   
    log_at                6.931000e-01  4.369400e+00  8.8541  11.4487  13.7914   
    sp_cfo_to_debt       -9.543091e+02 -7.606000e+00  0.0001   0.1333   0.3443   
    
                                 p95           p99           max    skew     kurt  
    sp_dcf_to_debt            3.1968  3.576861e+02  3.577370e+02 -6.8666  51.2077  
    sp_debt_to_ebitda        31.1958  5.667072e+03  5.667164e+03  6.0019  38.8569  
    sp_ffo_to_debt           12.7810  7.840926e+02  7.842414e+02 -5.4265  44.3318  
    sp_focf_to_debt           7.2503  6.138415e+02  6.140150e+02 -5.3263  42.4355  
    sp_interest_coverage  24716.9199  4.254267e+10  4.256850e+10  1.6889  27.7657  
    log_mkvalt               15.6682  1.645580e+01  1.645580e+01  0.7284  -0.1123  
    sp_debt_to_capital        1.0013  2.785900e+00  2.787600e+00 -0.6993  10.4693  
    log_at                   16.0542  1.785350e+01  1.785370e+01 -0.6152   0.1416  
    sp_cfo_to_debt           17.9883  9.446857e+02  9.448613e+02  0.2324  27.9858  
    
    Distribution summary (TRAIN | standardized feats)
                                n  mean  std     min     p01     p05     p25  \
    z_sp_dcf_to_debt        44783   0.0  1.0 -8.2142 -8.2122 -0.0378  0.1254   
    z_sp_debt_to_ebitda     44783   0.0  1.0 -1.8302 -1.8301 -0.1573 -0.1475   
    z_sp_ffo_to_debt        44783   0.0  1.0 -7.9384 -7.9323 -0.0313  0.0637   
    z_sp_focf_to_debt       44783  -0.0  1.0 -7.8241 -7.8189 -0.0389  0.0744   
    z_sp_interest_coverage  44783   0.0  1.0 -5.0653 -5.0639 -0.3340  0.0103   
    z_log_mkvalt            44783   0.0  1.0 -1.6541 -1.6540 -1.3693 -0.7188   
    z_sp_debt_to_capital    44783   0.0  1.0 -5.2123 -5.2065 -0.5258 -0.5253   
    z_log_at                44783   0.0  1.0 -2.9116 -2.9116 -1.8804 -0.6224   
    z_sp_cfo_to_debt        44783   0.0  1.0 -6.0713 -6.0695 -0.0788 -0.0307   
    ...
    z_sp_interest_coverage  0.0103  0.0103  0.0103  6.6066  6.6106  1.6889   
    ...
    z_sp_interest_coverage  27.7657  
    z_log_mkvalt            -0.1123  
    ...
    6  sp_interest_coverage -6.636551e+07 -7.459295e+08 -0.1051   0.1051
    2        sp_cfo_to_debt  4.850300e+00 -8.245700e+00 -0.0923   0.0923
    7                log_at  1.107300e+01  1.136440e+01  0.0836   0.0836
    0    sp_debt_to_capital  3.125000e-01  3.575000e-01  0.0774   0.0774
    8            log_mkvalt  7.052600e+00  7.205500e+00  0.0377   0.0377
    1        sp_ffo_to_debt -1.484170e+01 -2.073130e+01 -0.0273   0.0273
    3       sp_focf_to_debt -1.368230e+01 -1.831240e+01 -0.0271   0.0271
    4        sp_dcf_to_debt -2.619770e+01 -2.471760e+01  0.0076   0.0076
    5     sp_debt_to_ebitda  1.099131e+02  1.155231e+02  0.0074   0.0074
    
    Mean difference (target=1 minus target=0) on TRAIN feats [top 15]:
    sp_interest_coverage    1.310386e+08
    sp_debt_to_ebitda       2.227597e+02
    sp_dcf_to_debt          2.674640e+01
    sp_ffo_to_debt          1.985020e+01
    sp_focf_to_debt         1.547140e+01
    log_at                  1.718900e+00
    log_mkvalt              1.223100e+00
    sp_cfo_to_debt         -1.065900e+00
    sp_debt_to_capital      4.586000e-01
    dtype: float64
...
![png](v28_12_2_files/v28_12_2_7_0.png)
...
```
    ...
    dtype: float64
    size_decile
    (-0.001, 6.585]     0.027826
    (6.585, 8.38]       0.092138
    (8.38, 9.509]       0.093052
    (9.509, 10.52]      0.056150
    (10.52, 11.507]     0.051887
    (11.507, 12.554]    0.073585
    (12.554, 13.434]    0.099214
    (13.434, 14.245]    0.145912
    (14.245, 15.252]    0.184119
    (15.252, 21.886]    0.209715
    Name: distress_dummy, dtype: float64


    /var/folders/p1/_cwwbdbj51q1lwpynfnzdxpm0000gn/T/ipykernel_7030/2342790164.py:14: FutureWarning: The default of observed=False is deprecated and will be changed to True in a future version of pandas. Pass observed=False to retain current behavior or observed=True to adopt the future default and silence this warning.
      print(df.groupby("size_decile")["distress_dummy"].mean())
...
```
    ...
    Modeling matrix shapes:
      X_train: (44783, 9) | y_train mean=0.1075
...
```
    ...
    Best LogisticRegression on VAL: C=10.0 | AUC=0.8019
...
```
    ...
    Time:                        18:19:53   Log-Likelihood:                -13315.
    converged:                       True   LL-Null:                       -15282.
    Covariance Type:            nonrobust   LLR p-value:                     0.000
    ==========================================================================================
                                 coef    std err          z      P>|z|      [0.025      0.975]
    ------------------------------------------------------------------------------------------
    const                     -2.5392      0.022   -115.935      0.000      -2.582      -2.496
    z_sp_debt_to_capital       0.8319      0.017     48.174      0.000       0.798       0.866
    z_sp_ffo_to_debt           0.1990      0.060      3.304      0.001       0.081       0.317
    z_sp_cfo_to_debt          -0.2380      0.075     -3.169      0.002      -0.385      -0.091
    z_sp_focf_to_debt         -0.2193      0.165     -1.333      0.183      -0.542       0.103
    z_sp_dcf_to_debt           0.4701      0.140      3.369      0.001       0.197       0.744
    z_sp_debt_to_ebitda        0.1231      0.011     10.972      0.000       0.101       0.145
    z_sp_interest_coverage    -0.0065      0.020     -0.331      0.741      -0.045       0.032
    z_log_at                   0.5258      0.021     25.513      0.000       0.485       0.566
    z_log_mkvalt               0.1052      0.017      6.122      0.000       0.072       0.139
    ==========================================================================================
    ...
    ------------------------------------------------------------------------------
    x1             0.0564      0.001     46.480      0.000       0.054       0.059
    x2             0.0135      0.004      3.347      0.001       0.006       0.021
    x3            -0.0161      0.005     -3.190      0.001      -0.026      -0.006
    x4            -0.0149      0.011     -1.335      0.182      -0.037       0.007
    x5             0.0319      0.009      3.407      0.001       0.014       0.050
    x6             0.0083      0.001     10.856      0.000       0.007       0.010
    x7            -0.0004      0.001     -0.331      0.741      -0.003       0.002
    x8             0.0357      0.001     26.933      0.000       0.033       0.038
    x9             0.0071      0.001      6.130      0.000       0.005       0.009
    ==============================================================================
...
```
    ...
    0     1      2018       2017  0.8115  0.2717
    1     2      2019       2018  0.7996  0.3046
    2     3      2020       2019  0.7998  0.2961
    3     4      2021       2020  0.8049  0.2409
    
    Average AUC across folds: 0.8039
...
```
    ...
    AUC (ROC): 0.8019
    Average Precision (PR-AUC): 0.2404
    Brier score (calibration): 0.1941
    Threshold: 0.584
    ...
    Classification report:
               ...
               0     0.9557    0.8120    0.8780      5819
               1     0.2563    0.6326    0.3648       596
    
        accuracy                         0.7953      6415
       macro avg     0.6060    0.7223    0.6214      6415
    weighted avg     0.8907    0.7953    0.8303      6415
    
    Sensitivity (Recall of Distress): 0.6326
    Specificity (Recall of Non-Distress): 0.8120
    
    === TEST (same threshold) ===
    AUC (ROC): 0.7965
    Average Precision (PR-AUC): 0.2475
    Brier score (calibration): 0.2038
    Threshold: 0.584
    Confusion matrix [ [TN FP] [FN TP] ]:
    [[8785 2315]
     [ 449  855]]
    ...
    Classification report:
               ...
               0     0.9514    0.7914    0.8641     11100
               1     0.2697    0.6557    0.3822      1304
    
        accuracy                         0.7772     12404
       macro avg     0.6105    0.7236    0.6231     12404
    weighted avg     0.8797    0.7772    0.8134     12404
    
    Sensitivity (Recall of Distress): 0.6557
    Specificity (Recall of Non-Distress): 0.7914
...
![png](v28_12_2_files/v28_12_2_17_0.png)
    



    
![png](v28_12_2_files/v28_12_2_17_1.png)
    



    
![png](v28_12_2_files/v28_12_2_17_2.png)
    



    
![png](v28_12_2_files/v28_12_2_17_3.png)
...
```
    ...
    HistGradientBoosting (no heavy tuning):
      VAL  AUC=0.8995 | PR-AUC=0.5577
      TEST AUC=0.9121 | PR-AUC=0.6374
